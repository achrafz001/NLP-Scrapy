...
def stock_info(headings):
    ...
    for title in headings:
        ...
        for token in doc.ents:
            try:
                if (token.label_ == 'ORG') and (stocks_df['Company Name'].str.contains(token.text).sum()):
...
user_input =st.text_input("Add your RSS lin here !", "https://www.moneycontrol.com/rss/buzzingstocks.xml")
